...
<body>
	...
	<%-- condition이라는 요청 주소를 처리할 Controller 가 필요함  : JSTLConditionController--%>
	...
	<%-- loop라는 요청 주소를 처리할 Controller 가 필요함  : JSTLLoopController --%>
	...
	<%-- student/selectAll 라는 요청을 처리할 Controlelr : SelectAllController  --%>
	<br>
	...
	<%-- student/selectOne 라는 요청을 처리할 Controller : SelectOneController --%>
